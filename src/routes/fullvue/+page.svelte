    ...
    <div class="feature">
      ...
      <div class="feature-text">
        ...
        <div class="text">
          <h2>Sales Module</h2>
          <p>
            Track and log your interactions with your customers, keeping
            everything plotted on a clear timeline that is visible to the entire
